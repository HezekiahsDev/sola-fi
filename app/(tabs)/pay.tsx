...
export default function PayScreen() {
  const options: PayOption[] = [
    ...
    },
    {
      ...
      onPress: () => console.log("Send Fiat"),
    },
    {
      key: "card",
      title: "Card/Wallet",
      icon: <CreditCard color="#fff" size={20} />,
      onPress: () => console.log("Send Crypto/Card"),
    },
  ];
  ...
  return (
    <AnimatedGradient style={styles.container}>
      ...
      <RNView style={styles.decor} pointerEvents="none">
        <GlowOrb
          size={260}
          color="rgba(47,149,220,0.35)"
          style={{ top: -140, right: -80 }}
        />
        <GlowOrb
          size={300}
          color="rgba(14,165,233,0.22)"
          style={{ bottom: -160, left: -100 }}
        />
      </RNView>
      ...
      <View style={styles.content}>
        ...
        >
          {options.map((opt) => (
            <View key={opt.key} style={styles.glassWrapper}>
              <Pressable
                style={({ pressed }) => [
                  styles.glassBtn,
      ...
      <View style={styles.comingSoonOverlay}>
        ...
        <Text style={styles.comingSoonText}>
          Exciting new payment features are launching soon. Stay tuned for a
          seamless way to manage your finances.
        </Text>
      </View>
    </AnimatedGradient>
  );
